...
/** Centralized constants for test configuration to eliminate magic numbers
  * and improve test maintainability. All timeout values, delays, and test
  * data sizes are defined here with descriptive names.
  */
object TestConstants:
  ...
  object ToleranceValues:
    ...
    val TIMING_TOLERANCE_MS_VERY_LENIENT = 300.0  // 300ms for very lenient timing tests
