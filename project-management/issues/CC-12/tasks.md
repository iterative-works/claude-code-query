...
- [x] Phase 02: Source Reorganization (Est: 2-4h) → `phase-02-context.md`
- [x] Phase 03: Publishing Configuration (Est: 2-4h) → `phase-03-context.md`
- [x] Phase 04: Verification (Est: 1-2h) → `phase-04-context.md`
